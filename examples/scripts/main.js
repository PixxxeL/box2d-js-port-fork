...
var animate, cleanup, current, fps, getExamples, initBox2d, initDraw, initWorld, keyDown, mouseDown, mouseMove, mouseUp, setCurrentExampleIndex, title, world;
...
initWorld = function() {
  ...
  return document.getElementById('title-container').innerHTML = scene();
};
...
getExamples = function() {
  return [ragdoll, compound, crankGearsPulley, bridge, stack, pendulum, simple];
};
